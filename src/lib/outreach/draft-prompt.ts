...
- PARTNER COMPENSATION: never quote a percentage, a rate, a tier, or a dollar amount. Say "revenue share on orders" and stop — the comp model is an open legal question, so any number is a promise we cannot make. Never explain WHY it is unquantified; just write it that way.
