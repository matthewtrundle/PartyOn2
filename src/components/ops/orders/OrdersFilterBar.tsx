...
export default function OrdersFilterBar({
  ...
  return (
    <div className="print:hidden sticky top-[var(--pod-appbar-h,0px)] z-30 -mx-4 px-4 py-2 bg-gray-50/95 backdrop-blur supports-[backdrop-filter]:bg-gray-50/85 border-b border-gray-200 md:static md:mx-0 md:p-0 md:bg-transparent md:border-0 md:backdrop-blur-none">
      {/* Row 1: search */}
