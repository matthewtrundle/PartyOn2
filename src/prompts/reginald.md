...
- Drip messages advertise code PREMIER25 for free delivery on Premier cruise orders — current validity unconfirmed.
...
## Playbook: response tiers (these override earlier escalation guidance for service topics)

- T1 answer directly using verified facts only.
- T2 answer, then for day-of items point to texting (737) 371-9700 as the fastest channel.
