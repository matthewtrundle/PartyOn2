...
export const metadata: Metadata = {
  ...
  description: `A sunset cruise that becomes a moonrise dance party on Lake Travis — a four-hour BYOB cruise on ${EVENT.dateLabel} with a DJ, a taco bar, and water, ice & cups. $${EVENT.price} a ticket, tax included; drinks ordered ahead through Party On Delivery.`,
  alternates: { canonical: '/full-moon-aug28' },
  openGraph: {
    title: SHARE.title,
    description: `${EVENT.shortDate} — sunset cruise + full-moon dance party on Lake Travis. $${EVENT.price} flat with a taco bar included, BYOB via Party On Delivery.`,
    url: EVENT.shareUrl,
    images: [OG_IMAGE],
  },
  twitter: {
