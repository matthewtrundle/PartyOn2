      ...
      <main className="relative z-20 text-white">
        ...
        <section className="container-custom pt-40 pb-24">
          <div className="grid items-center gap-10 lg:grid-cols-2">
            ...
            <div>
              <div className="relative mx-auto aspect-[11/6] w-full max-w-xl overflow-hidden rounded-2xl border border-white/15 shadow-2xl">
                <Image
                  src="/images/hero-4th-of-july.jpg"
                  alt="Fourth of July cocktail kits delivered cold across the Austin area"
                  fill
                  priority
        ...
        <footer className="border-t border-white/10">
          <div className="container-custom py-8 text-center text-sm text-white/50">
            ...
            <p className="mt-1">© Party On Delivery</p>
          </div>
        </footer>
      </main>
